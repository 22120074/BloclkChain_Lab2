...
const deployedContracts = {
  ...
  11155111: {
    Corn: {
      address: "0x42bA2c149895d5B79eaA57b9D6FBE33e338E6C13",
      abi: [
        {
          inputs: [],
          stateMutability: "nonpayable",
      ...
      deployedOnBlock: 9944209,
    },
    CornDEX: {
      address: "0xd902044074bBf9e8413192B4587c39549a17CEfC",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9944210,
    },
    Lending: {
      address: "0x046cec23F4C1054f66811b053527A0fceB20F57c",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9944211,
    },
    MovePrice: {
      address: "0x77B2a25301475597CC207fA82bAbAa07CDE15cD1",
      abi: [
        {
          inputs: [
            {
